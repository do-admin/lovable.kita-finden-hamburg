...
const mockKitas = [
  {
    ...
    alter: "0-6 Jahre",
    plaetzeFrei: true,
    konzepte: ["Montessori", "Naturpädagogik"],
    betreuungszeit: "Ganztags",
  },
  {
    id: 2,
    name: "Kinderladen Alsterblick",
    adresse: "Alsterchaussee 45",
    bezirk: "Hamburg-Nord",
    stadtteil: "Winterhude",
    alter: "3-6 Jahre",
    plaetzeFrei: false,
    warteliste: true,
    konzepte: ["Reggio", "Bewegung"],
    betreuungszeit: "Ganztags",
  },
  {
    id: 3,
    name: "AWO Kita Harburg",
    adresse: "Harburger Ring 8",
    bezirk: "Harburg",
    stadtteil: "Harburg",
    alter: "0-3 Jahre",
    plaetzeFrei: true,
    konzepte: ["Inklusion", "Sprachförderung"],
    betreuungszeit: "Halbtags",
  },
  {
    id: 4,
    name: "Waldkindergarten Blankenese",
    adresse: "Blankeneser Hauptstraße 12",
    bezirk: "Altona",
    stadtteil: "Blankenese",
    alter: "3-6 Jahre",
    plaetzeFrei: true,
    konzepte: ["Waldorf", "Naturpädagogik"],
    betreuungszeit: "Halbtags",
  },
  {
    id: 5,
    name: "Kita Kleine Strolche",
    adresse: "Wandsbeker Chaussee 200",
    bezirk: "Wandsbek",
    stadtteil: "Wandsbek",
    alter: "0-6 Jahre",
    plaetzeFrei: false,
    warteliste: true,
    konzepte: ["Bilingual", "Musikalisch"],
    betreuungszeit: "Ganztags",
  },
  {
    id: 6,
    name: "Evangelische Kita St. Petri",
    adresse: "Mönckebergstraße 5",
  ...
  {
    id: 7,
    name: "Kita Bergedorfer Zwerge",
    adresse: "Bergedorfer Straße 78",
    bezirk: "Bergedorf",
    stadtteil: "Bergedorf",
    alter: "0-3 Jahre",
    plaetzeFrei: true,
    konzepte: ["Bewegung", "Naturpädagogik"],
    betreuungszeit: "Ganztags",
  },
  {
    id: 8,
    name: "Montessori Kinderhaus",
    adresse: "Grindelallee 100",
    bezirk: "Eimsbüttel",
