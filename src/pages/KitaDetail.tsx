        ...
        <div className="max-w-[1200px] mx-auto px-6 py-10 md:py-16">
          ...
          <div className="grid lg:grid-cols-3 gap-10 lg:gap-16">
            ...
            <div className="lg:col-span-2 space-y-10">
              ...
              {/* Contact Form */}
              <section id="vormerken" className="scroll-mt-8">
                <div className="bg-muted/50 rounded-2xl p-6 md:p-8">
                  <h2 className="text-2xl font-bold text-primary mb-2">
                    Jetzt Platz vormerken
                  </h2>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid md:grid-cols-2 gap-5">
                      ...
                      <div>
                        <Label htmlFor="kindesalter">Alter des Kindes *</Label>
                        <Select
                          value={formData.kindesalter}
                          onValueChange={(value) => setFormData({ ...formData, kindesalter: value })}
                        >
                          <SelectTrigger className="mt-1.5">
                            <SelectValue placeholder="Bitte wählen" />
                          </SelectTrigger>
                          <SelectContent>
                            <SelectItem value="0-1">0–1 Jahr</SelectItem>
                            <SelectItem value="1-2">1–2 Jahre</SelectItem>
                            <SelectItem value="2-3">2–3 Jahre</SelectItem>
                            <SelectItem value="3-4">3–4 Jahre</SelectItem>
                            <SelectItem value="4-5">4–5 Jahre</SelectItem>
                    ...
                    <div>
                      <Label htmlFor="startdatum">Gewünschter Starttermin</Label>
                      <Input
                        id="startdatum"
                        type="month"
