        ...
        <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-8 lg:gap-4 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mt-12 lg:mt-14">
              <h3 className="text-[20px] lg:text-[22px] font-semibold text-foreground mb-4 text-center lg:text-left">
                Beliebte Suchen
              </h3>
              <div className="flex flex-wrap justify-center lg:justify-start gap-3 lg:gap-4">
                {[
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-full border border-border bg-background hover:bg-muted text-[16px] font-medium text-foreground transition-colors"
                  >
                    {term}
                  </button>
                ))}
