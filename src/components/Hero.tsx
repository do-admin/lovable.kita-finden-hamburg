          ...
          <div className="relative flex justify-center lg:justify-end mt-8 lg:mt-0">
            ...
            <div className="relative w-[85%] sm:w-[320px] lg:w-[380px] lg:-ml-[80px]">
              ...
              <div className="absolute -top-4 -right-4 sm:-right-6 lg:-right-8 w-[200px] sm:w-[220px] lg:w-[240px] group cursor-default">
                <div 
                  className="relative rounded-[24px] px-7 py-6 bg-white border border-slate-200 shadow-[0_16px_48px_rgba(0,0,0,0.12)] transition-all duration-200 hover:scale-[1.03]"
                >
                  ...
                  <p className="text-[15px] lg:text-[16px] font-medium text-[#475569] mt-1">Kitas gelistet</p>
                </div>
              </div>
              ...
              <div className="absolute -bottom-6 -left-4 sm:-left-8 lg:-left-12 w-[88%] sm:w-[340px] lg:w-[400px] group cursor-default">
                <div 
                  className="relative rounded-[24px] px-7 sm:px-9 py-6 bg-white border border-slate-200 shadow-[0_16px_48px_rgba(0,0,0,0.12)] transition-all duration-200 hover:scale-[1.03]"
                >
                  <div className="flex items-center justify-between gap-6 sm:gap-12">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-[28px] sm:text-[32px] font-extrabold text-[#0f172a] leading-none">4,7</p>
                        <p className="text-[14px] sm:text-[15px] font-medium text-[#475569] mt-0.5">Ø Bewertung</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[14px] sm:text-[15px] font-medium text-[#475569] mt-0.5">Zufriedenheit</p>
                      </div>
                    </div>
                  </div>
                </div>
